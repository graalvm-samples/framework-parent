...
public class LoginDynamicBaseException extends AuthenticationException {
     ...
     * 禁用无参数构造
     */
//    private LoginDynamicBaseException() {
//        super();
//    }
     ...
     * @version 1.0
     */
    public LoginDynamicBaseException(String code, String msg) {
        super(msg);
     ...
     */
    public LoginDynamicBaseException(String code, String msg, String logMessage) {
        super(msg);
     ...
     * @version 1.0
     */
    public LoginDynamicBaseException(Throwable cause, String code, String msg) {
        super(msg,cause);
        if (cause != null) {
     ...
     * @param logMessage 服务端日志打印错误信息
     */
    public LoginDynamicBaseException(Throwable cause, String code, String msg, String logMessage) {
        super(msg,cause);
        this.logMessage = logMessage;
        if (cause != null) {
            this.initCause(cause);
